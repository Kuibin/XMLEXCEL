<?php
  ...
  class FacturasTest extends TestCase{
    ...
    public function generacionFactura() {
      ...
      $factura["data"][0]["datos_fiscales"]["llave_pem"]        = $cert->contenidoLlave("./certificados/key.pem");
    ...
    // foo::find();
    // $f = FacturasTest::generacionFactura();

    $factura = new FacturasTest;

    $factura->generacionFactura();
?>