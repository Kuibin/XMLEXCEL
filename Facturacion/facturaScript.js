...
function guardarConcepto(papa,clave_producto_servicio,clave_unidad,cantidad,descripcion,valor_unitario,importe,unidad,no_identificacion,Descuento,objetoimp) {
    ...
    let _Descuento=document.getElementById(Descuento).value;
    let _objetoimp=document.getElementById(objetoimp).value;
    ...
    if (_objetoimp == null || _objetoimp == "undefined" || _objetoimp == "") {return;}
...
///////////////////////////////////
    $('.buttonConceptos').click(function(){
      if($(this).text()=='Producto y Servicio - AGREGAR'){
        ...
        $(this).text('Producto y Servicio - AGREGAR');
      }
    });
...
let nuevo = function() {
  ...
  $("<section/>").insertBefore("[name='enviar']")//[name='enviar']
                 ...
                 <div class="col-6 col-md-4">
                    <label class="form-label" for="clave_producto_servicio">Producto o Servicio*</label>
                    <input type="search" list="clave_producto_servicioLista" class="form-control" id="clave_producto_servicio${numConceptos}" name="clave_producto_servicio${numConceptos}" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>
                  </div>
                  <div class="col-6 col-md-4">
                    <label class="form-label" for="clave_unidad">Unidad de Medida*</label>
                    <input type="search" list="clave_unidadLista" class="form-control" id="clave_unidad${numConceptos}" name="clave_unidad${numConceptos}" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>

                  </div>
                  <div class="col-6 col-md-4">
                  <label for="cantidad">Cantidad*</label>
                    <input type="text" class="form-control myCantidad" id="cantidad${numConceptos}" name="cantidad${numConceptos}" placeholder="" onchange="importeFormula('cantidad${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}'), guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>
                  </div>
                  <div class="col-6 col-md-4">
                  <label for="descripcion">Descripción Detallada*</label>
                    <input type="text" class="form-control" id="descripcion${numConceptos}" name="descripcion${numConceptos}" placeholder="" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>
                  </div>
                  <div class="col-6 col-md-4">
                  <label for="valor_unitario">Valor Unitario*</label>
                    <input type="text" class="form-control" id="valor_unitario${numConceptos}" name="valor_unitario${numConceptos}" placeholder="" onchange="importeFormula('cantidad${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}'), guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>
                  </div>
                  <div class="col-6 col-md-4">
                  <label for="importe">Importe</label>
                    <input type="text" class="form-control" id="importe${numConceptos}" name="importe${numConceptos}" placeholder="" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>
                  </div>
                  <div class="col-6 col-md-4">
                  <label for="unidad">Unidad</label>
                    <input type="text" class="form-control"  id="unidad${numConceptos}" name="unidad${numConceptos}" placeholder="" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')">
                  </div>
                  <div class="col-6 col-md-4">
                  <label for="unidad">Descuento</label>
                  <input type="text" class="form-control"  id="Descuento${numConceptos}" name="Descuento${numConceptos}" placeholder="" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')">
                </div>
                <div class="col-6 col-md-4">
                  <label class="form-label" for="objetoimp">Objeto de Impuesto*</label>
                  <input type="search" list="objetoimpLista" class="form-control" id="objetoimp${numConceptos}" name="objetoimp${numConceptos}" onchange="guardarConcepto('${numConceptos}','clave_producto_servicio${numConceptos}','clave_unidad${numConceptos}','cantidad${numConceptos}','descripcion${numConceptos}','valor_unitario${numConceptos}','importe${numConceptos}','unidad${numConceptos}','no_identificacion${numConceptos}','Descuento${numConceptos}','objetoimp${numConceptos}')" required>
                </div>
                  <div class="col-6 col-md-4">
                ...
                <h5>Calculo Inverso
                  ...
                  <div class="col-6 col-md-4">
                    <input type="text" class="form-control"  id="base.${numConceptos}-${numImpuestos}" name="base.${numConceptos}-${numImpuestos}" placeholder="" onchange="TotalImpuestosTrasladoFormula('base.${numConceptos}-${numImpuestos}','impuesto.${numConceptos}-${numImpuestos}','tipo_factor.${numConceptos}-${numImpuestos}','TotalImpuestosTraslado.${numConceptos}-${numImpuestos}'), guardarImpuestosTraslado('${numConceptos}','${numImpuestos}','inlineRadioOptions.${numConceptos}-${numImpuestos}','base.${numConceptos}-${numImpuestos}','impuesto.${numConceptos}-${numImpuestos}','tipo_factor.${numConceptos}-${numImpuestos}','TotalImpuestosTraslado.${numConceptos}-${numImpuestos}')" required>
                    <label for="base">Base</label>
                  </div>
                  <div class="col-6 col-md-4">
                    <input type="text" class="form-control"  id="TotalImpuestosTraslado.${numConceptos}-${numImpuestos}" name="TotalImpuestosTraslado.${numConceptos}-${numImpuestos}" placeholder="" onchange="guardarImpuestosTraslado('${numConceptos}','${numImpuestos}','inlineRadioOptions.${numConceptos}-${numImpuestos}','base.${numConceptos}-${numImpuestos}','impuesto.${numConceptos}-${numImpuestos}','tipo_factor.${numConceptos}-${numImpuestos}','TotalImpuestosTraslado.${numConceptos}-${numImpuestos}')" required>
...
$("<section/>").insertBefore(`[name='finImpuesto${papa}']`)//[name='enviar']
                ...
                <h5>Calculo Inverso
                  ...
                  <div class="col-6 col-md-4">
                    <input type="text" class="form-control"  id="base.${papa}-${numImpuestos}" name="base.${papa}-${numImpuestos}" placeholder="" onchange="TotalImpuestosTrasladoFormula('base.${papa}-${numImpuestos}','impuesto.${papa}-${numImpuestos}','tipo_factor.${papa}-${numImpuestos}','TotalImpuestosTraslado.${papa}-${numImpuestos}'), guardarImpuestosTraslado('${papa}','${numImpuestos}','inlineRadioOptions.${papa}-${numImpuestos}','base.${papa}-${numImpuestos}','impuesto.${papa}-${numImpuestos}','tipo_factor.${papa}-${numImpuestos}','TotalImpuestosTraslado.${papa}-${numImpuestos}')" required>
                    <label for="base">Base</label>
                  </div>
                  <div class="col-6 col-md-4">
                    <input type="text" class="form-control"  id="TotalImpuestosTraslado.${papa}-${numImpuestos}" name="TotalImpuestosTraslado.${papa}-${numImpuestos}" placeholder="" onchange="guardarImpuestosTraslado('${papa}','${numImpuestos}','inlineRadioOptions.${papa}-${numImpuestos}','base.${papa}-${numImpuestos}','impuesto.${papa}-${numImpuestos}','tipo_factor.${papa}-${numImpuestos}','TotalImpuestosTraslado.${papa}-${numImpuestos}')" required>
                    <label for="TotalImpuestosTraslado">Total Impuesto Traslado</label>
                  </div>
                </div>
                <br>
