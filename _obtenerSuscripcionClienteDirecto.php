...
// $idCliente = 'cus_2qu23XA7aFj5CcNYk';//$jsonCliente->idSuscriptor;

$idConekta = $_POST['idConekta'];

// $url= 'https://api.conekta.io/customers/'.$idConekta.'/subscription';
$url= 'https://api.conekta.io/customers/'.$idConekta;
// $url= 'https://api.conekta.io/customers/'.$idCliente.'/subscription';
