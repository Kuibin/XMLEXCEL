...
foreach ($xml->xpath('//cfdi:Comprobante') as $cfdiComprobante){ 
      ...
      $hoja->setCellValueByColumnAndRow(11, 3+$contadorXMLConvertidos,$cfdiComprobante['FormaPago']);
...
$stringSumas = 'H'.strval(3+$contadorXMLConvertidos).':'.'J'.strval(3+$contadorXMLConvertidos);
$hoja->getStyle('H2:J2')->applyFromArray($styleArray);
$hoja->getStyle($stringSumas)->applyFromArray($styleArrayTop);
//Suma
//subtotal
$cellSubtotal = 'H'.strval(3+$contadorXMLConvertidos);
$sumaSubtotal = '=SUM(H3:'.'H'.strval(2+$contadorXMLConvertidos).')';
$hoja->setCellValue($cellSubtotal, $sumaSubtotal);
//Descuento
$cellDescuento = 'I'.strval(3+$contadorXMLConvertidos);
$sumaDescuento = '=SUM(I3:'.'I'.strval(2+$contadorXMLConvertidos).')';
$hoja->setCellValue($cellDescuento, $sumaDescuento);
//Total
$cellTotal = 'J'.strval(3+$contadorXMLConvertidos);
$sumaTotal = '=SUM(J3:'.'J'.strval(2+$contadorXMLConvertidos).')';
