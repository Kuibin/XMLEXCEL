...
<html lang="es">
  ...
  <div class="container-fluid">
          <form class="row g-2 col-10 col-md-10 col-lg-10 bg-white rounded shadow p-3 fw-light mb-3 mb-md-0" method="POST" id="formA" action="guardar.php">
          <div class="col-auto">
          <label for="articulo">Articulo</label>
              <input type="text" class="form-control" id="articulo" name="articulo" onchange="lecturaBarras()" placeholder="0">
          </div>
          <div class="col-auto">
  ...
  <br>
        ...
        <div class="col-auto">
          <label>Unidades</label>
            ...
            <form class="row g-3 col-10 col-md-10 col-lg-10 bg-white rounded shadow p-3 fw-light mb-3 mb-md-0" method="POST" id="formC">
  ...
  <br>
        ...
        <div class="col-auto">
          <label>Valores</label>
            ...
            <form class="row g-3 col-10 col-md-10 col-lg-10 bg-white rounded shadow p-3 fw-light mb-3 mb-md-0" method="POST" id="formE">
            <div class="col-auto">
        ...
        <!-- <button type="button" class="btn btn-primary" id="btnEnviar" action="#">ENVIAR </button>   -->
